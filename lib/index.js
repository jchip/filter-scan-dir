...
function walkSync(path, options) {
  ...
  return options.grouping ? options.result : options.result._;
}
...
function filterScanDir(options) {
  ...
  return walk("", Object.assign({}, options, { result: { _: [] }, _path: Path }));
}

filterScanDir.sync = function filterScanDirSync(options) {
  if (typeof options === "string") options = { dir: options };
  return walkSync("", Object.assign({}, options, { result: { _: [] }, _path: Path }));
};
